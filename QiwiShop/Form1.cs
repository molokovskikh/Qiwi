...
namespace QiwiShop
{
    public partial class Form1 : Form
    {
        ...
        private static void SetCert(ShopClientWSClient cli)
        {
            cli.ClientCredentials.ClientCertificate.Certificate = ShopClientWSServer.Certificate;
        }

        private void button1_Click(object sender, EventArgs e)
        {
            MessageBox.Show(ShopClientWSServer.Help());
        }
        ...
        void Test_updateBill()
        {
            ...
            string url = "https://localhost:8735/Qiwi/";
            //Запускаем хост
            new Task(delegate()
                {
                    ShopClientWSServer.Host(new Uri(url));
                }).Start();
